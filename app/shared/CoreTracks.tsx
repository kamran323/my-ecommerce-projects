...
const CoreTracks = () => {
  return (
    ...
    <div className='absolute left-0 hidden sm:block'>
        <div className='blur-[150px] -z-20 bg-[#05c19cb3] w-64 rounded-full'>
    ...
    <Wrapper>
        ...
        <div className='max-w-screen-sm '>
            ...
            <h2 className='text-3xl font-bold whitespace-pre-line leading-8 text-black'>Core Courses
                <br /> (Common in All Specializations):</h2>
